...
public class WebTableLoginPage {
    ...
    public void loginWithConfig(){
        inputUsername.sendKeys(azul.utilities.ConfigurationReader.getProperty("web.table.username"));
        inputPassword.sendKeys(azul.utilities.ConfigurationReader.getProperty("web.table.pw"));
        loginButton.click();
    }
}
