...
public class Driver {
    ...
    public static WebDriver getDriver(){
        ...
        if (driverPool.get() == null){
             ...
             */
            String browserType = azul.utilities.ConfigurationReader.getProperty("browser");
            ...
            */
            switch (browserType){
                ...
                case "remote-chrome":
                    ...
                    String gridAdress = "44.202.98.3"; // put your own Linux grid IP here
                    try {
