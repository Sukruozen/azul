...
public class Order_StepDefinitions {
    ...
    azul.pages.BasePage basePage = new azul.pages.BasePage();
    azul.pages.OrderPage orderPage = new azul.pages.OrderPage();
    azul.pages.ViewAllOrdersPage viewAllOrdersPage = new azul.pages.ViewAllOrdersPage();

    @Given("user is already logged in and on order page")
    public void user_is_already_logged_in_and_on_order_page() {
        //Getting the page using the URL from configuration.properties
        azul.utilities.Driver.getDriver().get(azul.utilities.ConfigurationReader.getProperty("web.table.url"));

        //Calling our login method to log in to web table app
        webTableLoginPage.login();

        //clicking to "order" link to go order pageHooks
...
//    }
    ...
    public void user_selects_credit_card_type(String expectedCardType) {
        ...
        azul.utilities.BrowserUtils.clickRadioButton(orderPage.cardType, expectedCardType);
