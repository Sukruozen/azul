...
public class WebTable_StepDefinitions {
    ...
    public void user_is_on_the_login_page_of_web_table_app() {
        String url = azul.utilities.ConfigurationReader.getProperty("web.table.url");
        azul.utilities.Driver.getDriver().get(url);
    }
    ...
    public void user_should_see_url_contains_orders() {
        azul.utilities.BrowserUtils.verifyURLContains("orders");
    }
